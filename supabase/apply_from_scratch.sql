...
-- (نفس محتوى migrations/0003_deposit_receipts_and_links.sql، مضاف هنا
--  ليبقى هذا الملف كافيًا وحده لبناء القاعدة من الصفر)
...
-- ═══ 0004 — خصم المجموعة ═══════════════════════════════════════════
-- (نفس محتوى migrations/0004_group_discount.sql)
